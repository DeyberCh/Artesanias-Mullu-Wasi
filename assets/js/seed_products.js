...
(function seedProducts(){
  try {
    ...
    const sample = [
      ...
      { id: String(now + 5),  name: "Collar de Joyería Andina", desc: "Collar único con cuentas y elementos de la región. Ideal como regalo.", category: "Joyería", stock: 18, price: 75.00, image: "../assets/img/collar_joya.jpg", artisan: "Anthony Joyería", sold: 10 },
      ...
      { id: String(now + 12), name: "Instrumento de de Percusión - Cajita", desc: "Pequeño instrumento de percusión hecho con fibras y madera. Perfecto para niños.", category: "Instrumentos", stock: 14, price: 48.00, image: "../assets/img/cajita.jpg", artisan: "Don Daniel Instrumentos", sold: 7 },
      { id: String(now + 13), name: "Taza de Barro Cocido", desc: "Taza rústica para café, sin esmaltar. Capacidad 300 ml.", category: "Ceramica-Alfareria", stock: 45, price: 8.50, image: "../assets/img/ceramica-y-alfareria/taza_barro_coci.png.png", artisan: "Taller Ruiz", sold: 5 }
    ];
